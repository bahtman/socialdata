...
CleanedData = data.drop(["Start_Time",'Number',"Precipitation(in)","Pressure(in)","Wind_Direction","ID","End_Time","Wind_Chill(F)","Description","City","County","Zipcode","Timezone","Weather_Timestamp",'Distance(mi)','Airport_Code','Street','Side','Country','Amenity','Bump','Crossing','Give_Way','Junction','No_Exit','Railway','Roundabout','Station','Stop','Traffic_Calming','Traffic_Signal','Turning_Loop','Sunrise_Sunset','Civil_Twilight','Nautical_Twilight','Astronomical_Twilight', 'End_Lat','End_Lng'],axis='columns', inplace=False)
